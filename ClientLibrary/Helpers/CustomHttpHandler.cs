...
{
    public class CustomHttpHandler(GetHttpClient getHttpClient, LocalStorageService localStorageService, UserAccountService accountService) : DelegatingHandler
    {
